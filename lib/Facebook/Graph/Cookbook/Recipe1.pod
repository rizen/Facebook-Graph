...
Fill in the "Connect URL" field. It should be something like C<https://www.yourapplication.com/facebook/>. It is the base URL to where you'll be deploying your application. The trailing slash is required.
...
Now we point our browser to:
 ...
 https://www.yourapplication.com/facebook
